    ...
    <section id="process" className="py-[120px] relative">
      <div className="max-w-[1180px] mx-auto px-8">
        ...
        >
          ...
          />
          {phases.map((p, i) => (
            <div key={p.id} className="relative pr-7 py-6 max-md:pb-8 max-md:border-b max-md:border-paper-200 md:[&:not(:last-child)]:border-r md:[&:not(:last-child)]:border-paper-200">
              ...
              <div className="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-paper-50 border border-paper-200 text-shadow-700 mt-[18px]" data-phase-icon={i + 1}>
              ...
              <div className="bg-paper-50 border border-paper-200 rounded-md px-3 py-2.5 text-[13px] leading-[1.4]">
                <span className="block font-mono text-[10px] uppercase tracking-wider text-mist-600 mb-1">[ // YOU GET ]</span>
                {p.deliv}
              </div>
            </div>
          ))}
