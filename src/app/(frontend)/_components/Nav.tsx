  ...
  return (
    <div className="sticky top-0 z-10 bg-paper-100/85 backdrop-blur-md border-b border-paper-200">
      <div className="max-w-[1180px] mx-auto px-8 h-[72px] flex items-center justify-between gap-8">
        <a href="#top" aria-label="Coderoach Studio — home" className="flex items-center gap-[10px]">
          ...
          <span className="flex flex-col leading-none tracking-[-0.02em] gap-[2px] text-ink">
            <span className="font-sans text-[14px] font-bold">coderoach</span>
            <span className="font-sans text-[14px] font-bold">studio</span>
          </span>
        </a>
        <div className={`flex gap-7 items-center ${open ? '' : 'max-md:hidden'}`}>
          ...
          <a href="#products" className="text-sm font-medium hover:text-electric">Products</a>
        ...
        <div className="flex items-center gap-3">
          {data?.navStatus?.label && (
            <span className="hidden md:inline-flex items-center gap-2 px-3 h-9 rounded-md border border-paper-200 bg-paper-50 text-[13px] font-medium tabular">
